...
- [x] Remove provider keys from tower `.env` files — coinbot cleaned 2026-06-15 (`docs/TOWER_CLEANUP.md`)
...
- [ ] Document exceptions in `config/wire_exceptions.yaml` if something must bypass gateway — see `docs/WHY_MODELROUTER.md`
